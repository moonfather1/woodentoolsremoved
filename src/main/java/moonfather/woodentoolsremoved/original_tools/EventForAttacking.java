...
public class EventForAttacking
{
    ...
    private static final Component woodenToolMessage = new TranslatableComponent("message.woodentoolsremoved.sword_message_1").withStyle(Style.EMPTY.withColor(0x9e7b4d));
}
