...
public class FirestarterItem extends FlintAndSteelItem
{
    ...
    private static final double MAX_TOOL_DISTANCE = Math.sqrt(ServerGamePacketListenerImpl.MAX_INTERACTION_DISTANCE) - 1.0D;
    ...
    private static final Component ERROR_TOO_FAR = Component.translatable("item.woodentoolsremoved.firestarter.error").withStyle(Style.EMPTY.withColor(Constants.COLOR_MESSAGE_GRAY));
